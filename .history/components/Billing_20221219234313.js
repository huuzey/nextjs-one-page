...
const Billing = () => {
  ...
  return (
    <div className="sm:columns-1 md:columns-2">
      ...
      <div data-aos="slide-left" className="pt-10 font-poppins">
        ...
        <div className="flex">
          <Image
            className="max-w-[30%] max-h-[20%] hover:scale-110"
            src={googleplay}
          ></Image>
          <Image
            className="max-w-[30%] max-h-[20%] object-contain  hover:scale-110 "
            src={appstore}
          ></Image>
        </div>
      </div>
