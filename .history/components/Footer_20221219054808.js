...
const Footer = () => {
  ...
  return (
    <div>
      <div data-aos="zoom-out" className="sm:columns-1 md:columns-3">
        ...
        <div>
          <div className="text-white flex flex-col ml-10 py-4 col-span-1">
            ...
            <br className="sm:hidden md:visible"></br>
            <br className="sm:hidden md:visible"></br>
            <br className="sm:hidden md:visible"></br>
          </div>
        </div>
      ...
      <hr></hr>
      <div data-aos="zoom-out" className="sm:columns-1 md:columns-2 ">
