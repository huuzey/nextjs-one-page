...
const Hero = () => {
  return (
    <div className="lg:columns-2 sm:columns-1 md:columns-1">
      ...
      <div className="flex text-white divide-x flex-1 sm:text-[30px] md:text-[40px] justify-between">
        <div className="">
          2000+ <span className="text-gradient "> Active users</span>
        </div>
        <div>
          200+ <span className="text-gradient"> TRUSTED BY Company</span>
        </div>
        <div>
          $200M+ <span className="text-gradient"> TRANSACTION</span>
        </div>
      </div>
