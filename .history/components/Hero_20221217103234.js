  ...
  return (
    <div className="lg:columns-2 sm:columns-1 md:columns-1">
      ...
      <div className="flex text-white   ">
        <div className="">
          2000+ <span className="text-gradient  mr-2 "> Active users</span>
        </div>
        <div>
          200+ <span className="text-gradient  mr-2"> TRUSTED BY Company</span>
        </div>
        <div>
          $200M+ <span className="text-gradient  mr-2"> TRANSACTION</span>
        </div>
      </div>
