...
const Hero = () => {
  return (
    <div className="lg:columns-2 sm:columns-1 md:columns-1">
      <div className="text-white font-poppins bg-gray-900  w-[50%] rounded-xl shadow-sm shadow-cyan-500 flex flex-row mt-8 ml-12 items-center justify-center">
        <Image
          src={discount}
          alt="discount"
          className="flex item-self-start mr-2 w-[42px] h-[42px] "
        ></Image>
