...
const Hero = () => {
  return (
    <div className="lg:columns-2 sm:columns-1 md:columns-1">
      <div className="text-white font-poppins bg-gray-900 first:justify-start  w-[50%] rounded-xl shadow-sm shadow-cyan-500 flex flex-row mt-8 ml-12 items-center justify-center">
        <Image
          src={discount}
          alt="discount"
