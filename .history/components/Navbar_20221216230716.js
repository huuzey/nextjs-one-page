...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="justify-between relative  bg-primary text-white   flex items-center">
        <div className="flex">
        ...
        <div className="absolute text-white lg:hidden sm:flex-col sm:flex-col right-3 top-2">
          <Image
