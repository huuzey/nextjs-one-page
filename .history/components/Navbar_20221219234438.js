...
const Navbar = () => {
  ...
  return (
    <div className="" data-aos="fade-up">
      <div className=" justify-between     bg-primary text-white   flex items-center">
        <div className="flex">
          <Image src={logo} width={40} height={2} alt="logo of tesla"></Image>
          <p className="text-bold">Tesla</p>
        </div>
        <div className="hidden lg:flex px-5 text-gradient ">
        ...
        <div className="absolute text-white lg:hidden sm:flex-col md:flex-col right-3 top-2">
          ...
          ></Image>
          <div className={`${toggle ? "visible" : "hidden"} text-gradient`}>
