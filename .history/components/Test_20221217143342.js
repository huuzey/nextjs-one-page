...
const Test = () => {
  return (
    <div className="sm:columns-1 md:columns-3">
      <div className="ml-12 hover:bg-gray-800 rounded-xl pt-5 items-center justify-center text-white">
      ...
      <div>
        <div className="ml-12 hover:bg-gray-800 pt-5 rounded-xl text-white">
          <p className="max-w-[250px] mt-5">
      ...
      <div>
        <div className="ml-12 hover:bg-gray-800 rounded-xl pt-5 text-white">
          <p className="max-w-[250px] mt-5">
