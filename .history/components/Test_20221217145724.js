...
const Test = () => {
  return (
    <div>
      ...
      <div className="sm:columns-2 md:columns-4 flex items-center  justify-center">
        <Image className="max-w-[188px]" src={airbnb}></Image>
        <Image className="max-w-[188px]" src={coinbase}></Image>
        <Image className="max-w-[188px]" src={binance}></Image>
        <Image className="max-w-[188px]" src={dropbox}></Image>
      </div>
    </div>
  );
};
