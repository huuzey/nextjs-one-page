...
const Try = () => {
  return (
    <section className="flex items-center justify-center mt-7 bg-gray-900  py-4 mb-4 rounded-lg  md:ml-[14rem] md:mr-[14rem] sm:ml-[8rem] sm:mr-[8rem]">
      <div className="text-white">
        <h1 className="md:text-[40px] md:text-[20px]">
