...
import beats from "../public/image/beats.png";

export default function () {
  const [count, setcount] = useState(0);
  return (
    <div>
      <div className="mt-3 flex h-12 bg-white sticky top-0  z-10 justify-between px-3 py-4 shadow-2xl  xl:max-w-[100vw] whitespace-nowrap">
        {/*left side */}
        <div className="flex ">
